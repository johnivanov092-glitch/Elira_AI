...
### 110. Test coverage expansion — web_temporal/compute_freshness, web_query/is_strict_web_only_query, memory/context pure helpers, core/memory._content_hash (4 zero-covered modules) (Claude Code)
- Status: completed
- Scope: first tests for four previously zero-covered modules spanning infrastructure and application layers.
- tests/test_memory_context_and_web_temporal_pure.py (68 tests): infrastructure/search/web_temporal.py compute_freshness (returns-tuple/two-elements/both-strings/freshness-sensitive-with-news-fresh-checked/fresh-note-content/with-fetched-pages-fresh/with-deeper-search-fresh/no-evidence-unverified/unverified-note/stable-historical-state/stable-historical-note/default-standard-web/standard-web-note/empty-temporal-standard-web); infrastructure/search/web_query.py is_strict_web_only_query (returns-bool/weather-true/today-true/current-true/latest-true/usd-true/eur-true/news-true/general-false/empty-false/none-false/case-insensitive/mixed-case-today); application/memory/context.py default_content_hash (returns-string/32-hex-chars/deterministic/different-texts-different/normalizes-case-and-strips/empty-produces-hash); _memory_type_weight (returns-float/profile-highest/profile-weight/chat-weight/unknown-fallback/pinned-flag-adds-bonus/manual-source-adds-bonus/insight-above-chat/pinned-type/summary-weight/all-positive); _clean_memory_text (returns-string/short-unchanged/strips-whitespace/collapses-spaces/long-truncated/truncated-ends-ellipsis/empty-empty/none-empty/exact-limit-not-truncated); _memory_query_words (returns-list/short-excluded/long-included/empty-empty/none-empty/returns-lowercase/three-chars-included/two-chars-excluded); core/memory._content_hash (returns-string/32-hex-chars/deterministic/different-texts/normalizes-case/empty-known-hash/matches-default-content-hash).
- Verification: 2407/2407 tests pass.


### 111. Test coverage expansion — application/memory/web_knowledge.py pure helpers (clean_browser_text, chunk_browser_text, build_browser_rag_records, build_web_knowledge_records) (Claude Code)
- Status: completed
- Scope: first tests ever for the four pure functions in web_knowledge.py (previously zero-covered).
- tests/test_web_knowledge_pure.py (69 tests): clean_browser_text (returns-string/empty-returns-empty/none-returns-empty/plain-unchanged/tabs-replaced/carriage-return-replaced/multiple-spaces-collapsed/leading-stripped/trailing-stripped/mixed-whitespace/already-clean/only-whitespace-empty/newlines-not-modified/many-tabs-become-single-space/unicode-unchanged); chunk_browser_text (returns-list/empty-empty/none-empty/all-whitespace-empty/short-single-chunk/exactly-size-one-chunk/longer-multiple-chunks/all-strings/all-nonempty/covers-all-text/default-size-1200/custom-size/size-at-most-N/cleaned-before-chunking); build_browser_rag_records (returns-list/empty-both-empty/summary-creates-record/summary-has-required-keys/url-preserved/goal-preserved/content-cleaned/empty-summary-skipped/whitespace-summary-skipped/page-text-creates-browser-page/page-required-keys/page-url/page-goal/long-page-multiple-chunks/both-summary-and-page/summary-before-page/all-dicts); build_web_knowledge_records (returns-list/empty-context-empty/none-context-empty/whitespace-context-empty/creates-web-summary/first-is-summary/web-summary-required-keys/url-empty-string/goal-equals-query/content-contains-query/title-equals-query/default-source-kind/custom-source-kind/web-chunk-created/chunk-required-keys/chunk-url-empty/chunk-goal-equals-query/chunk-source-kind/max-chars-limits/long-query-title-truncated-300/all-dicts/empty-query/none-query). Fix: _call() helper substitutes None with default context — direct call used for None test.
- Verification: 2476/2476 tests pass.

### 112. Test coverage expansion — domain/agents/planner_prompts.py + planner_graphs.py pure helpers (Claude Code)
- Status: completed
- Scope: first tests ever for two uncovered domain/agents modules (planner_prompts.py 97 lines, planner_graphs.py 224 lines); only pure functions tested (make_task_graph skipped — calls LLM).
- tests/test_planner_prompts_and_graphs_pure.py (69 tests): planner_prompts.py build_task_graph_prompt (returns-string/contains-task/nonempty/json-schema-hint/mentions-browser/mentions-reasoning/mentions-terminal/different-tasks/empty-task/long-task); build_planner_plan_prompt (returns-string/contains-task/nonempty/mentions-browser/mentions-reasoning/mentions-terminal/different-tasks/empty-task); build_planner_summary_prompt (returns-string/contains-task/contains-context/contains-plan-json/nonempty/empty-plan/different-tasks); build_task_graph_reasoning_prompt (returns-string/contains-task/contains-node-goal/contains-dep-context/empty-dep-fallback/nonempty/none-dep-fallback); build_task_graph_summary_prompt (returns-string/contains-task/contains-state/contains-graph-json/nonempty/empty-graph/different-tasks). planner_graphs.py normalize_planner_steps (returns-list/non-list-default/none-default/empty-default/valid-normalized/unknown-filtered/last-is-reasoning/already-reasoning/list-of-dicts/each-has-tool/each-has-goal/at-most-5/non-dict-skipped/terminal-accepted); normalize_task_graph (returns-list/non-list-default/none-default/empty-default/valid-normalized/unknown-filtered/last-is-reasoning/all-have-required-keys/all-dicts/at-most-7/depends-on-list/self-ref-removed/non-dict-skipped/memory-lookup-accepted/duplicate-ids-handled/invalid-deps-filtered).
- Verification: 2545/2545 tests pass.

### 113. Test coverage expansion — planner_runtime.py + orchestrator_postprocess_runtime.py + terminal_tool.py pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 8 pure functions across three previously zero-covered domain modules.
- tests/test_planner_and_orchestrator_postprocess_pure.py (84 tests): planner_runtime.py extract_first_url (returns-string/empty-empty/none-empty/no-url-empty/http-extracted/https-extracted/path-extracted/trailing-period-stripped/trailing-comma-stripped/trailing-paren-stripped/only-first-returned/url-only-text/with-query-string); planner_safe_terminal_command (returns-bool/empty-false/none-false/ls-safe/ls-flags-safe/dir-safe/pwd-safe/git-status-safe/git-branch-safe/pip-list-safe/python-version-safe/git-commit-unsafe/pip-install-unsafe/rm-rf-false/shutdown-false/case-insensitive/arbitrary-false); task_graph_context_from_deps (returns-string/no-depends-on-empty/empty-depends-empty/dep-not-in-results-skipped/dep-with-result-included/tool-shown/multiple-joined/missing-output/none-output); build_task_graph_state_blob (returns-string/empty-empty/single-formatted/failed-shows-fail/goal-included/multiple-all-present/max-30000/missing-output). orchestrator_postprocess_runtime.py build_reflection_kb_context (returns-string/empty-empty/only-kb/only-working/both-joined/empty-skipped/whitespace-skipped/other-keys-ignored); build_reflection_memory_context (returns-string/empty-empty/only-memory/only-working/both-joined/empty-skipped/kb-ignored); build_finalize_prompt (returns-string/nonempty/contains-task/contains-memory/contains-kb/contains-working/empty-state/different-tasks). terminal_tool.py is_dangerous_command (returns-bool/safe-false/empty-false/none-false/rm-rf-dangerous/shutdown-dangerous/reboot-dangerous/format-c-dangerous/mkfs-dangerous/deltree-dangerous/git-status-safe/pip-list-safe/case-insensitive/blocked-as-substring).
- Verification: 2629/2629 tests pass.

### 114. Test coverage expansion — orchestrator_context_runtime + self_improve_runtime + step_executor pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 14 pure functions across three previously zero-covered domain modules.
- tests/test_self_improve_step_executor_pure.py (97 tests): orchestrator_context_runtime.py build_tool_hint_text (returns-string/empty-header/tool-name-shown/success-rate-shown/uses-count/multiple-all-included/computed-from-runs/tool-name-key-fallback). self_improve_runtime.py build_self_improve_combined_context (returns-string/all-empty/mem-included/kb-included/working-included/all-three/none-handled); build_self_improve_critique_prompt (returns-string/nonempty/contains-task/contains-answer/contains-context/json-hint/different-tasks/long-answer-truncated); should_self_improve (returns-bool/iter1-no-critique-true/iter2-no-critique-false/critique-true/critique-false/needs-retry-overrides/not-complete-overrides/non-dict-ignored/none-ignored); is_self_improve_complete (returns-bool/non-dict-false/none-false/empty-dict-true/complete-false/answered-false/needs-retry-true/all-positive/needs-retry-false). step_executor.py _resolve_path (simple-key/nested/missing-none/empty-path/deep/non-dict-mid-none/none-data); _resolve_input_expression (non-string-as-is/none-as-is/dollar-input/dollar-input-full/dollar-context/dollar-context-full/dollar-steps/dollar-steps-full/plain-string/missing-path); _map_step_inputs (returns-dict/no-map-empty/maps-expression/maps-literal/multiple-keys); _stringify_template_value (none-empty/string-as-is/int-converted/float-converted/dict-json/list-json/bool-converted); _render_prompt_template (no-placeholders/single/missing-empty/multiple/dict-value/none-empty/extra-ignored); _determine_profile_name (returns-string/config-priority/universal-fallback/researcher-fallback/unknown-default/empty-fallback); _step_label (returns-string/config-label/save-as-fallback/id-fallback/empty); _resolve_next_step (returns-string/no-next-empty/string-direct/list-success/list-failure/always-both/on-error-fallback/no-match-empty/string-stripped).
- Verification: 2726/2726 tests pass.

### 115. Test coverage expansion — domain/agents/orchestrator_runtime.py pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 6 pure functions in orchestrator_runtime.py (previously zero-covered).
- tests/test_orchestrator_runtime_pure.py (58 tests): normalize_v8_route (returns-dict/dict-as-is/none-fallback/string-fallback/list-fallback/fallback-has-mode/fallback-has-confidence/same-object/empty-dict); select_v8_graph (returns-list/direct-returns-list/planner-has-planner/task-graph-has-task-graph/self-improve-has-self-improve/unknown-strategy-falls-to-mode/unknown-mode-default/all-strings/all-strategies-end-with-finalize/chat-mode-fallback); build_v8_state (returns-dict/run-id/task/model-name/selected-strategy/graph/memory-ctx-empty/kb-ctx-empty/answer-empty/errors-list/timeline-list/reflection-dict/required-keys); compute_reflection_quality_score (returns-float/none-1.0/empty-1.0/all-false-0.2/all-true-1.0/partial-intermediate/0-to-1/non-dict-1.0); build_run_agent_v8_result (returns-dict/run-id/mode/answer-from-state/latency/errors-from-state/delegated-strategy/required-keys/graph); build_self_improving_result (returns-dict/run-id/answer/iterations/reflection-as-final/working-overrides/empty-uses-base/mode-from-base/required-keys).
- Verification: 2784/2784 tests pass.

### 116. Test coverage expansion — orchestrator_execution_runtime + browser_action_tool + browser_agent_tool pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 7 pure functions across three previously zero-covered domain modules.
- tests/test_browser_and_execution_pure.py (62 tests): extract_task_graph_answer (returns-string/non-dict-empty/none-empty/list-empty/final-key/answer-key/summary-key/final-priority/empty-dict-empty/execution-log-used/steps-key/last-two-log-items/empty-log-empty); browser_runtime_hint (returns-string/notimplemented-windows-hint/subprocess-transport-hint/executable-install-hint/browsertype-install/generic-returns-text/empty/none/exception-object); sync_playwright_available (returns-bool/consistent-result); sanitize_browser_actions (returns-list/none-empty/empty-empty/open-kept/allowed-actions/unknown-filtered/non-dict-skipped/max-12/required-keys/ms-defaults-1000/ms-preserved/invalid-ms-fallback/case-insensitive); goal_keywords (returns-list/empty-empty/none-empty/short-excluded/stopwords-excluded/content-included/lowercase/max-12/each-3-chars); score_link (returns-int/empty-zero/same-domain-bonus/different-domain/keyword-adds/login-penalized/social-penalized/docs-positive/multiple-keywords); rank_links (returns-list/empty-empty/respects-limit/relevant-higher/dicts/score-key/zero-limit).
- Verification: 2846/2846 tests pass.

### 117. Test coverage expansion — domain/agents/router.py + reflection.py + application/agent_registry/builtins.py pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 5 pure functions across three previously function-level-uncovered modules (discovered via direct grep for function names, as module names were already referenced in test imports for other purposes).
- tests/test_router_reflection_builtins_pure.py (62 tests): router.py route_task (returns-dict/empty-chat/none-chat/generic-chat/python-code/bug-code/api-code/pdf-file/docx-file/excel-file/research-research/browser-research/web-research/pipeline-multi-step/roadmap-multi-step/required-keys/confidence-float/use-graph-bool/chat-use-graph-false/code-use-graph-true/file-priority-over-code/case-insensitive). reflection.py safe_json_object (returns-dict/empty-empty-dict/none-empty-dict/invalid-empty-dict/valid-dict/list-empty-dict/string-empty-dict/nested-dict/embedded-json/empty-dict-json); count_false_flags (returns-int/empty-zero/all-true-zero/one-false-one/two-false-two/all-five-false/grounded-counts/actionable-counts/safe-counts/unknown-ignored/none-treated-false/zero-treated-false); get_fallback_node_v8 (returns-string/task-graph-planner/planner-finalize/reflection-v2-finalize/finalize-finalize/unknown-empty/empty-name-empty/state-not-used). builtins.py _match_role (returns-tuple/three-elements/all-strings/no-match-custom/no-match-preserves-name/no-match-builtin-prefix/truncated-28/empty-custom/unmatched-custom/lowercases-before-matching).
- Verification: 2908/2908 tests pass.

### 118. Test coverage expansion — project_brain/chat+files+uploads + workflows/execution + identity_guard pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 12 pure functions across five previously function-level-uncovered modules.
- tests/test_project_brain_workflows_identity_pure.py (107 tests): project_brain/chat.py clean_html_text (returns-string/empty-empty/plain-unchanged/bold-stripped/italic-stripped/script-stripped/style-stripped/html-entities-decoded/whitespace-collapsed/nested-stripped/multiline-script/attribute-stripped); build_code_prompt (returns-string/contains-goal/contains-path/contains-content/empty-refs/single-ref/multiple-refs/nonempty). project_brain/files.py normalize_relative_path (returns-path/simple/backslash-normalised/empty-raises/whitespace-raises/parent-traversal-raises/nested-traversal-raises/leading-slash-stripped); looks_text_file (returns-bool/py-text/js-text/txt-text/md-text/json-text/jpg-not-text/png-not-text/pdf-not-text/zip-not-text/dockerfile-text/gitignore-text/case-insensitive); hash_bytes (returns-string/deterministic/different-input/empty-bytes-sha256/hex-string/64-chars). project_brain/uploads.py safe_filename (returns-string/clean-unchanged/spaces-replaced/special-chars-replaced/empty-returns-attachment/none-returns-attachment/long-truncated/dot-preserved/dash-preserved); attachment_summary (returns-dict/required-keys/id-preserved/name-preserved/size-preserved/suffix-preserved/text-available-preserved/preview-from-text/preview-truncated-1200/no-text-empty-preview). workflows/execution.py parse_workflow_datetime (returns-datetime/none-returns-none/empty-returns-none/invalid-returns-none/naive-gets-utc/tz-aware-converted-utc/utc-unchanged/result-always-utc/random-invalid-none); workflow_step_index (returns-int/first-step-1/second-step-2/last-step-count/not-found-uses-results-len/two-step-results/empty-ordered-ids/empty-step-results). identity_guard/runtime.py _contains_model_identity (returns-bool/empty-false/none-false/plain-false/model-only-false/fp-only-false/model-and-fp-true/gpt-true/gemma-true/case-insensitive); _still_drifting (returns-bool/empty-false/none-false/plain-false/model-only-false/drift-true/gpt-drift); _rewrite_identity_drift (returns-string/empty-string/clean-preserved/drift-removed/non-drifting-kept/not-empty-for-all-drift/persona-in-fallback).
- Verification: 3015/3015 tests pass.

### 119. Test coverage expansion — monitoring/store + workflows/multi_agent + persona/store pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 8 pure functions across three previously function-level-uncovered modules.
- tests/test_monitoring_multi_agent_persona_pure.py (70 tests): monitoring/store.py dumps_json (returns-string/dict-serialized/none-as-empty-dict/list-serialized/nested/unicode-not-escaped/empty-dict/integer); loads_json (valid-dict/valid-list/none-returns-default/empty-returns-default/invalid-returns-default/roundtrip/default-preserved/zero-parsed); planner_tool_aliases (returns-list/nonempty/all-strings/web-search/memory-search/python-executor/deterministic). workflows/multi_agent.py _select_multi_agent_workflow_id (returns-string/both-true-full/orch-only-orchestrated/refl-only-reflection/both-false-default/four-distinct-ids/nonempty); _step_answer (returns-string/missing-key-empty/answer-key-used/output-answer-used/output-result-used/empty-dict-empty/non-dict-stringified/non-dict-step-results-empty/none-step-results-empty/empty-answer-empty/falsy-non-dict-empty); _build_multi_agent_timeline (returns-list/empty-template/no-steps/no-matching-skipped/non-dict-skipped/ok-done/failed-error/agent-is-step-id/label-from-config/label-fallback-key/length-reflects-answer/multiple-steps/required-keys). persona/store.py json_dumps (returns-string/dict/list/unicode/empty/integer/bool); json_loads (valid-dict/valid-list/empty-fallback/none-fallback/invalid-fallback/deepcopy/roundtrip/zero/false).
- Verification: 3085/3085 tests pass.

### 120. Test coverage expansion — web_query_planner/runtime + code_agent/python_lab pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 5 pure functions across two previously function-level-uncovered modules.
- tests/test_web_query_planner_python_lab_pure.py (50 tests): web_query_planner/runtime.py _should_merge (returns-bool/different-intents-false/finance-finance-true/price-rate-same-geo-true/price-rate-diff-geo-false/general-news-false/status-current-false/geo-news-false); _augment_current_query (returns-string/no-geo-no-time/geo-label-appended/geo-label-not-appended-city/geo-label-not-appended-country/time-window-appended/time-window-not-doubled/empty-empty/result-stripped/both-appended); _build_subquery (returns-dict/required-keys/query-contains-segment/general-web-intent/original-index/segment-stored/preferred-domains-list/different-indices); _default_single_query (returns-dict/is-multi-intent-false/total-1/pass-count-1/overflow-false/subqueries-1/uncovered-empty/passes-1/required-keys/no-segment-key/no-index-key). code_agent/python_lab.py ok_check (returns-bool/nonzero-false/returncode-2-false/zero-no-errors-true/empty-stderr-true/traceback-false/valueerror-false/typeerror-false/warning-true/deprecation-warning-true/empty-both-true/error-in-middle-false/nonzero-warning-false).
- Verification: 3135/3135 tests pass.

### 121. Test coverage expansion — workflows/store + agent_sandbox + tool_registry + agent_registry/builtins pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 7 pure functions/types across four previously function-level-uncovered modules.
- tests/test_workflows_store_sandbox_registry_pure.py (68 tests): workflows/store.py _as_bool (returns-bool/truthy-int/zero-false/none-false/nonempty-string/empty-string/list-truthy/empty-list); _loads (none-default/empty-default/invalid-default/valid-dict/valid-list/zero-string/false-string/roundtrip/type-error-default); _dumps (returns-string/none-empty-dict/empty-dict/dict/list/nested/unicode/integer); normalize_graph (empty-raises/no-steps-raises/empty-steps-raises/non-dict-step-raises/missing-id-raises/duplicate-id-raises/unknown-type-raises/agent-missing-agent-id-raises/tool-missing-tool-name-raises/nonexistent-entry-step-raises/returns-dict/entry-defaults-first/entry-explicit/steps-key/steps-count/required-keys/tool-normalized/pause-after-false/next-none). agent_sandbox/runtime.py _make_error/SandboxPolicyError (returns-error/message-set/agent-id-set/reason-set/details-set/none-details-empty/str-message/is-runtime-error/details-copied). tool_registry/runtime.py _noop_handler (returns-dict/ok-false/error-key/error-nonempty/consistent). agent_registry/builtins.py iter_builtin_agent_defs (returns-iterable/nonempty/each-dict/has-id/has-role/has-name/ids-builtin-prefix/deterministic/unique-ids/has-prompt-or-desc).
- Verification: 3203/3203 tests pass.

### 122. Test coverage expansion — router/choose_v8_strategy + planner_graphs + rag_memory_service/_cosine_sim + persona/row_to_version + skills_extra encrypt/decrypt pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 7 pure functions across five previously function-level-uncovered modules.
- tests/test_router_v8_planner_graphs_extra_pure.py (60 tests): domain/agents/router.py choose_v8_strategy (returns-dict/required-keys/strategy-string/confidence-float/confidence-0-1/scores-dict/force-returns-forced/force-confidence-1/force-source-forced/force-learned-empty/chat-prefers-direct/research-strategy/multi-step-strategy/known-strategies-in-scores/empty-task-ok). domain/agents/planner_graphs.py planner_default_steps (returns-list/nonempty/max-4/last-reasoning/tool-key/goal-key/url-adds-browser/url-first/url-has-url-field/no-url-plain). task_graph_default (returns-list/nonempty/max-6/last-reasoning/has-id/has-tool/has-depends-on/url-adds-browser/unique-ids). application/rag_memory_service/runtime.py _cosine_sim (returns-float/identical-1/orthogonal-0/opposite-neg1/empty-0/different-lengths-0/zero-vector-0/partial-between). application/persona/store.py row_to_version (none-returns-none/returns-dict/payload-parsed/source-parsed/fields-preserved/payload-json-removed/empty-payload/invalid-payload-fallback). application/skills_extra/runtime.py encrypt_text/decrypt_text (encrypt-dict/ok-true/has-encrypted/original-length/nonempty-token/decrypt-dict/decrypt-ok/roundtrip/invalid-ok-false/invalid-has-error).
- Verification: 3263/3263 tests pass.

### 123. Test coverage expansion — core/llm build_system_prompt + workflows/store row converters + workflows/execution build_workflow_execution_state pure helpers (Claude Code)
- Status: completed
- Scope: first tests for 5 pure functions across three previously function-level-uncovered modules.
- tests/test_llm_build_prompt_workflows_store_run_pure.py (61 tests): core/llm.py build_system_prompt (returns-string/nonempty-no-contexts/file-ctx-included/empty-file-not-injected/project-ctx-included/empty-project-not-injected/web-excluded-use-web-false/web-included-use-web-true/web-excluded-even-if-nonempty/mem-excluded-false/mem-included-true/unknown-profile-str/unknown-profile-nonempty/all-contexts-combined); get_available_models (returns-dict/nonempty/all-keys-strings/all-values-strings/deterministic). application/workflows/store.py _row_to_template (none-none/returns-dict/graph-parsed/input-schema-parsed/output-schema-parsed/graph-json-removed/input-schema-removed/output-schema-removed/enabled-bool/enabled-truthy/enabled-falsy/other-fields-preserved/invalid-graph-fallback). _row_to_run (none-none/returns-dict/input-parsed/context-parsed/step-results-parsed/pending-steps-parsed/error-parsed/input-json-removed/pending-steps-removed/requested-pause-bool/requested-pause-false/requested-pause-true/invalid-input-fallback). application/workflows/execution.py build_workflow_execution_state (returns-state/ordered-ids/total-steps/single-step/empty-steps/workflow-input/input-missing-empty/current-step-id/current-step-id-missing/steps-by-id-keys/steps-by-id-values/graph-dict/graph-steps/no-graph-empty/get-run-used/none-get-run-fallback).
- Verification: 3324/3324 tests pass.

### 124. test(#124): 64 pure-function tests across workflows/multi_agent, web_query_planner, response_cache, monitoring
- Status: completed
- File: backend/tests/test_workflows_cache_search_monitoring_pure.py
- Classes (6): BuiltinWorkflowTemplatesTest (13 tests) — _builtin_workflow_templates returns 4 templates each with id/name/graph/enabled/version/source; IDs start with builtin.workflow.multi_agent.; steps present; unique IDs; deterministic. BuildSearchQueryTest (10 tests) — _build_search_query dispatches on intent_kind (finance/geo_news/general_news/price_rate/status_current/historical/general_web); returns string; unknown intent falls through to stripped segment. NormalizeQueryTest (7 tests) — _normalize_query lowercases/strips/collapses-whitespace/removes-punctuation/idempotent. QueryHashTest (7 tests) — _query_hash returns 64-char hex; deterministic; different inputs produce different hashes; empty inputs ok. AllKnownToolsTest (7 tests) — all_known_tools returns list of nonempty strings; no duplicates; deterministic; contains web_search. DefaultLimitPayloadTest (14 tests) — default_limit_payload returns dict with agent_id/max_runs_per_hour/max_execution_seconds/max_context_tokens/allowed_tools/created_at; correct types; positive limits; different agent_ids differ.
- Verification: 3388/3388 tests pass.

### 125. test(#125): 45 pure-function tests for core/files and workflows/execution
- Status: completed
- File: backend/tests/test_core_files_workflow_exec_pure.py
- Classes (5): ShouldIncludeProjectFileTest (13 tests) — should_include_project_file accepts py/md/json/ts/yaml/sql; rejects exe/png/zip; blocks .git/node_modules/__pycache__/.venv directory parts. FormatChatSearchResultsTest (7 tests) — format_chat_search_results returns empty string for empty list; includes filename/score/content for non-empty; handles multiple results. BuildUploadedSignatureTest (8 tests) — build_uploaded_signature returns empty for None/[]; includes name and size in pipe-separated output; handles objects without size attribute (defaults to 0). ChatFolderPathTest (8 tests) — _chat_folder_path returns CHAT_DIR for None/empty/"default"/"Общее"; returns child of CHAT_DIR for custom names; sanitizes slashes and colons; different names give different paths. WorkflowDurationMsTest (9 tests) — workflow_duration_ms returns int; returns 0 for empty/None/missing/invalid started_at; returns positive int for past ISO timestamps.
- Verification: 3433/3433 tests pass.
