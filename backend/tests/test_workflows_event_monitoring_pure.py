...
from app.application.agent_registry.sandbox import SandboxPolicyError  # noqa: E402
...
class MonitoringStoreConstantsTest(unittest.TestCase):
    ...
    def test_default_max_context_tokens_means_auto(self) -> None:
        # Adaptive context: a DEFAULT limit row must NOT cap the window — 0 is
        # the Auto sentinel; only an explicitly configured positive cap shrinks
        # a run below the live server n_ctx.
