"""Tests for pure helpers across five modules.
  ...
  application/workflows/execution.py    — parse_workflow_datetime,
                                           workflow_step_index
  application/identity_guard/runtime.py — _contains_model_identity,
                                           _still_drifting,
...
# ─────────────────────────────────────────────────────────────────────────────
# identity_guard/runtime.py — _contains_model_identity
# ─────────────────────────────────────────────────────────────────────────────
...
class ContainsModelIdentityTest(unittest.TestCase):
    ...
    def test_model_and_first_person_true(self) -> None:
        # Russian first-person "я" + model name → True
...
# ─────────────────────────────────────────────────────────────────────────────
# identity_guard/runtime.py — _still_drifting
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# identity_guard/runtime.py — _rewrite_identity_drift
# ─────────────────────────────────────────────────────────────────────────────
