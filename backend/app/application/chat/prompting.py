...
def build_prompt(
    *,
    ...
    return (
        ...
        "5. У источников выше метки ✅/🟡/⚠️ — это твой ориентир, не печатай их. "
        "✅ подавай уверенно, 🟡 — с оговоркой, ⚠️ — честно как непроверённое («достоверность не гарантирую»). "
        "Не повышай уровень сам; факты из памяти без источника выше не добавляй.\n"
