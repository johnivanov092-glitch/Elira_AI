"""Planner V2 service: route classification and tool-selection planning.

Extracted from services/planner_v2_service.py.  services/planner_v2_service.py is now a
