"""Web query planner: multi-intent decomposition and web search planning.

Extracted from services/web_query_planner.py.  services/web_query_planner.py is now a
