# -*- coding: utf-8 -*-
"""Application-layer runtime for the Agent Registry (Agent OS Phase 1).

Owns DB_PATH, CREATE SQL, seed flag, and all connection-wiring wrappers
that delegate to ``application/agent_registry/store.py``.
