"""Persona service: SQLite-backed persona versioning, promotion, and calibration.

Extracted from services/persona_service.py.  services/persona_service.py is now a
