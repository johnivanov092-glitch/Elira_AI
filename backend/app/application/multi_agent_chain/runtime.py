# -*- coding: utf-8 -*-
"""Application-layer runtime for the multi-agent chain pipeline.

Owns the legacy orchestration helpers (kept as reference) and the active
public entrypoint ``run_multi_agent`` which delegates to the Workflow Engine.
...
# ── legacy pipeline (reference only — not called in production) ───────────────
...
def run_multi_agent(
    ...
    """Active entrypoint — delegates to the Workflow Engine."""
