"""Agent sandbox policy enforcement (preflight checks, tool allowlists, rate limits).

Extracted from services/agent_sandbox.py.  services/agent_sandbox.py is now a
