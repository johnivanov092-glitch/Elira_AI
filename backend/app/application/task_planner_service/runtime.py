# -*- coding: utf-8 -*-
"""Application-layer runtime for the Task Planner service.

Owns DB_PATH, PRIORITIES/STATUSES constants, connection wiring, and all
wrapper functions that delegate to ``application/task_planner/runtime.py``.
