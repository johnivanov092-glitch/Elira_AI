# -*- coding: utf-8 -*-
"""Application-layer runtime for PlannerV2 — intent routing and tool selection.

Classifies a user query into a route (chat / research / project / code) and
selects the appropriate tool set using keyword scoring and temporal-intent
analysis.  Pure Python, no HTTP, no DB.
"""
...
def _count(query: str, words: set) -> int:
