# -*- coding: utf-8 -*-
"""Application-layer runtime for project filesystem operations.

Owns directory traversal, safe path resolution, file read/write, and
full-text search over the project tree.  Pure Python — no HTTP, no DB,
no FastAPI imports.

``BASE_DIR`` resolves to the project root (Elira_AI/) regardless of where
this file is located in the source tree.
"""
...
# runtime.py is at backend/app/application/project_service/runtime.py
# parents: [0]=project_service/, [1]=application/, [2]=app/, [3]=backend/, [4]=Elira_AI/
