"""autopipeline_service — Autopipelines (cron-задачи) Elira AI.

Extracted from services/autopipeline_service.py.  services/autopipeline_service.py
is now a thin re-export facade; all logic lives here.
