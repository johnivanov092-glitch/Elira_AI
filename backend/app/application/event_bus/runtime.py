# -*- coding: utf-8 -*-
"""Application-layer runtime for the Event Bus (Agent OS Phase 3).

Owns DB_PATH, CREATE SQL, and all connection-wiring wrapper functions that
delegate to ``application/event_bus/store.py``.
