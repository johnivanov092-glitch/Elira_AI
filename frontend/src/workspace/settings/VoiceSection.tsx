...
export function VoiceSection() {
  ...
  return (
    <Wrap title="Голос Elira">
      <Note>
        Озвучивание ответов (TTS) на самохостед-движке Silero (CPU, LAN, строго локально;
        правильные русские ударения + шумоподавление). Голос выбираешь в списке ниже; кнопка «Озвучить» есть под каждым ответом.
      </Note>
