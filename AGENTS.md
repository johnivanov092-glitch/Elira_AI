...
Active work: rebuilding the UI into one workspace — see
`docs/FRONTEND_REBUILD_PLAN.md` (v4 layout, blueprint
`Elira_AI_mockups/unified_workspace_v3.html`) and `docs/CODE_AGENT_REWRITE_PLAN.md`
